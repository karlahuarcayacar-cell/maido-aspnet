...
- **UI/UX (Login):** Se rediseñó completamente la página de Inicio de Sesión (`Account/Login.cshtml`). Se sustituyó la tarjeta blanca simple por un diseño inmersivo *Split-Screen* / *Hero* con una fotografía premium de fondo oscurecida, una tarjeta `.glass-card` con animación `fade-in-up`, y grupos de inputs integrados visualmente (seamless borders).
