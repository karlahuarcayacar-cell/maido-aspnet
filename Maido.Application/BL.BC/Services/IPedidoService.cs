...
public interface IPedidoService
{
    ...
    Task<(IEnumerable<PedidoResumenDto> Items, int Total)> ListarPaginadoAsync(int pagina, int registrosPorPagina, string? estado, DateTime? fechaInicio, DateTime? fechaFin);
